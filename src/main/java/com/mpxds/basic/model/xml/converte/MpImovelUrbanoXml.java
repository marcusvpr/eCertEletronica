...
public class MpImovelUrbanoXml {
	...
	public MpImovelUrbanoXml() {};

	public MpImovelUrbanoXml(String campo01, String campo02, String campo03, String campo04, String campo05,
	...
	@XmlAttribute(name="NumeroMatricula")
	...
	@XmlAttribute(name="TipoRecolhimento")
