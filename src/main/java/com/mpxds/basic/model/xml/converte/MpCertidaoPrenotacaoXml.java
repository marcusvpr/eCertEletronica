...
public class MpCertidaoPrenotacaoXml {
	...
	public MpCertidaoPrenotacaoXml() {};

	public MpCertidaoPrenotacaoXml(String campo01, String campo02, String campo03, String campo04, String campo05,
	...
	@XmlAttribute(name="NumeroRecibo")
