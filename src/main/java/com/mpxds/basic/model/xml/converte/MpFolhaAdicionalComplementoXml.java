...
@XmlRootElement(name="FolhaAdicionalComplemento")
@XmlAccessorType(XmlAccessType.PROPERTY)
@XmlType(propOrder = {"campo01", "campo02", "campo03", "campo04", "campo05",
		 			  "mpEmolumentosXml"})
public class MpFolhaAdicionalComplementoXml {
	//
	...
	public MpFolhaAdicionalComplementoXml() {};

	public MpFolhaAdicionalComplementoXml(String campo01, String campo02, String campo03, String campo04, String campo05,
