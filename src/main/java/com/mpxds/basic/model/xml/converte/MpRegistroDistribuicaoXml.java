...
public class MpRegistroDistribuicaoXml {
	//
	...
	private List<MpFolhaAdicionalComplementoXml> mpFolhaAdicionalComplementoXmls = 
	...
	public MpRegistroDistribuicaoXml() {};

	public MpRegistroDistribuicaoXml(String versaoLayout, MpRemessaXml mpRemessaXml) {
		//
		super();
	...
	public MpRegistroDistribuicaoXml(String versaoLayout, MpRemessaXml mpRemessaXml,
			...
			List<MpCertidaoGenericaXml> mpCertidaoGenericaXmls, 
			List<MpCertidaoPrenotacaoXml> mpCertidaoPrenotacaoXmls,
	...
	public void setMpDistribuicaoExtrajudicialXmls(List<MpDistribuicaoExtrajudicialXml> 
																					newMpDistribuicaoExtrajudicialXmls) {
	...
	public void setMpFolhaAdicionalComplementoXmls(List<MpFolhaAdicionalComplementoXml> 
																					newMpFolhaAdicionalComplementoXmls) { 
